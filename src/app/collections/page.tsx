...
const collections = [
  { name: 'Agent Tools', desc: 'Automation, monitoring, and workflows', color: 'from-red-500/10 to-white' },
  { name: 'Trading & Alpha', desc: 'Signals, scanners, and market bots', color: 'from-emerald-500/10 to-white' },
  { name: 'Creative', desc: 'Prompts, brand kits, and content packs', color: 'from-indigo-500/10 to-white' },
  { name: 'IRL Goods', desc: 'Physical items, merch, and hardware', color: 'from-amber-500/10 to-white' },
];
